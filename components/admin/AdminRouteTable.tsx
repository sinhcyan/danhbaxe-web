                        ...
                        <td className="px-8 py-6">
                            <div className="flex gap-2 justify-end">
                                ...
                                {currentUserRole === 'admin' && onDelete && (
                                    <button title="Xóa" className="h-10 w-10 flex items-center justify-center bg-white/50 hover:bg-red-50 hover:text-red-500 text-slate-400 rounded-xl transition-all border border-white/50">
